![node_express](https://github.com/user-attachments/assets/ed00e76f-8df9-4404-981b-4b35027ec043)
# 📦 Node MVC CRUD App
...
project-root/ ├── src/ │ ├── controllers/ │ ├── models/ │ ├── routes/ │ ├── validators/ │ └── app.js ├── .env └── package.json
